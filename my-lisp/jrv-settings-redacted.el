...
(defcustom jrv/settings-download-rss-emails *******
  "*Whether emacs should download rss-feed emails"
  :type 'boolean
  :group 'JRVarma)
...
(defcustom jrv/settings-hostname *******
  "*Hostname as returned by the O/S"
  :type 'string
  :group 'JRVarma)
...
(defcustom jrv/settings-is-home-pc *******
  "*Whether this is my Home PC"
  :type 'boolean
  :group 'JRVarma)

(defcustom jrv/settings-is-office-pc *******
  "*Whether this is my Office PC"
  :type 'boolean
  :group 'JRVarma)

(defcustom jrv/settings-latex-help-file *******
...
(defcustom jrv/settings-minimal-emacs *******
  "*Whether minimal or complete emacs installation"
  :type 'boolean
  :group 'JRVarma)
...
(defcustom jrv/settings-offline-python-help-file *******
